...
func NewDefaultJSONRenderOption() *JSONRenderOption {
	return &JSONRenderOption{
		Zip:          true,
		ZipThreshold: 512,
		GzipLevel:    gzip.DefaultCompression,
		DeflateLevel: flate.DefaultCompression,
		Before:       defaultBefore1,
	}
}


func defaultBefore1(w http.ResponseWriter, r *http.Request) {
	//DENY ： 不允许被任何页面嵌入；
